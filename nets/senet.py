...
class SENet50(BaseNet):
    def __init__(self, weights_path=None) -> None:
        ...
        self.model.classifier = nn.Conv2d(2048, 1, kernel_size=[1, 1], stride=(1, 1))
...
if __name__ == '__main__':
    ...
    normalize = transforms.Compose(
        [
            ...
            transforms.ToTensor(),
            transforms.Normalize(mean=[0.51408314, 0.40738314, 0.3588051 ], 
                                std=[1.0,        1.0,        1.0]),
        ]
    )
    ...
    np.save('data/features_vggface.npy', acc)
